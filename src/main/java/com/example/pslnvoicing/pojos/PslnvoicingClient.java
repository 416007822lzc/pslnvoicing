...
public class PslnvoicingClient {
    ...
    public boolean equals(Object o) {
        ...
        return clientId == that.clientId &&
                ...
                Objects.equals(clientContactNumber, that.clientContactNumber);
    }

    @Override
    public int hashCode() {
        return Objects.hash(clientName, clientId, clientNum, clientType, clientPriceRatio, clientReceivablesBalance, clientBalancePrepayment, clientActualReceivable, clientAddress, clientHead, clientContact, clientCreator, clientCreateTime, clientUpdateTime, clientPhone, clientContactNumber);
    }
}
